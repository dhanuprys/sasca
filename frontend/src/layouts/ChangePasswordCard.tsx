...
function ChangePasswordCard() {
    ...
    const user = useUser();
    const changePassword = (old_password: string, password: string) => {
            ...
            <div className="p-4 sm:p-7">
                ...
                <div className="mt-5">
                    ...
                    <Formik
                        ...
                        onSubmit={async ({ old_password, password }, { setSubmitting }) => {
                        ...
                        {({ isSubmitting }) => (
                            <Form>
                                <div className="grid gap-y-4">
                                    {/* <!-- Form Group --> */}
                                    <div>
                                        <label htmlFor="old-password-input" className="block text-sm mb-2 dark:text-white">Password Lama</label>
                                        <div className="relative">
                                            <Field type="password" id="old-password-input" name="old_password" className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error" />
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center">
                                            <label htmlFor="password-input" className="block text-sm mb-2 dark:text-white">Password</label>
                                        </div>
                                        <div className="relative">
                                            <Field type="password" id="password-input" name="password" className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="password-error" />
                                            <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                                                <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                                </svg>
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center">
                                            <label htmlFor="confirm-password-input" className="block text-sm mb-2 dark:text-white">Konfirmasi Password</label>
                                        </div>
                                        <div className="relative">
                                            <Field type="password" id="confirm-password-input" name="confirm_password" className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="password-error" />
                                            <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                                                <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                                </svg>
