                ...
                <div className="grid grid-cols-4 items-center py-4 text-white">
                    <div className="col-span-3 flex gap-4 items-center">
                        <div className="shrink-0">
                            {
                                user && user.user
                                    ? <img className="w-[37px] h-[37px] bg-slate-200 rounded-full" src="/user.webp" alt="image" />
                    ...
                    <div className="flex justify-end">
                        ...
                        <div className="px-2 py-1 rounded-full bg-yellow-600 text-white text-xs">ADMIN</div>
                    </div>
                </div>
            </CommonWrapper>
        </div>
